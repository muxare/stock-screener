...
```
cp workflow/docs/ideas/<tier>/<idea>.md → backlog/ideas/IDEA-001.md
...
# copy sad-wf workflow files (.claude, tools, backlog templates, workflow/docs/ideas/)
cp /path/to/sad-wf/workflow/docs/ideas/small/quote-jar.md backlog/ideas/IDEA-001.md
/refine-idea IDEA-001 PLAN-001
```
