...
Fixes #1–#4 live in `workflow/tools/board.py` + `.gitignore`; the last is a docs/skill
edit.
...
flowchart TD
    ...
    ENF["workflow/tools/board.py + hooks + .workflow/events.jsonl<br/>(single sanctioned mutator; logs every op)"]:::enf
