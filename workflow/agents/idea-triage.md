...
## What you read
- `python workflow/tools/board.py idea-list --json` — the live inbox (ids, captured date, text).
...
- `python workflow/tools/board.py list --json` and `validate` — to spot ideas that duplicate
